...
function FormIcon() {
  return (
   ...
   C36.775,1,37,1.225,37,1.5V30.5z"
        ...
        <path
          fill="#808184"
          d="M31.5,14h-25C5.673,14,5,14.673,5,15.5v10C5,26.327,5.673,27,6.5,27h25c0.827,0,1.5-0.673,1.5-1.5v-10
   ...
   c0.275,0,0.5,0.225,0.5,0.5V25.5z"
        ...
        <path
          fill="#808184"
          d="M31.5,5h-25C5.673,5,5,5.673,5,6.5v3C5,10.327,5.673,11,6.5,11h25c0.827,0,1.5-0.673,1.5-1.5v-3
