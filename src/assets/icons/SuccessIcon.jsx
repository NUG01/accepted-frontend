...
function SuccessIcon() {
  return (
    ...
    >
      ...
      <path
        style={{ fill: "#88CC2A" }}
        d="M256,478.609c-122.75,0-222.609-99.864-222.609-222.609S133.25,33.391,256,33.391
 S478.609,133.256,478.609,256S378.75,478.609,256,478.609z"
      />
      <path
        style={{ fill: "#7FB335" }}
        d="M478.609,256c0-122.744-99.859-222.609-222.609-222.609v445.217
 C378.75,478.609,478.609,378.744,478.609,256z"
      />
      <path
        style={{ fill: "#FFFFFF" }}
        d="M233.739,356.174c-8.544,0-17.087-3.261-23.609-9.783l-68.804-68.804
 ...
 C250.827,352.913,242.283,356.174,233.739,356.174z"
      ...
      <path
        style={{ fill: "#EDF0F2" }}
        d="M329.021,180.283L256,253.3v94.192c0.435-0.393,0.928-0.681,1.348-1.101l118.891-118.891
